...
const Login = () => {
    ...
    const onSubmit = (e) => {
        e.preventDefault();
        axios.post("http://localhost:2345/login", ldetails)
        .then((res) => {
        ...
        <div>
            ...
            <div className="l-container">
                <div className="l-welcome">
                    ...
                    <p> <span className="bluetxt">DEV Community</span> is a community of 823,581 amazing developers</p>
                    <div className="btns">
                        <button className="apple"><RiAppleFill /> &nbsp; Continue with Apple</button>
                        <button className="google"><ImGoogle2 /> &nbsp; Continue with Google</button>
                        <button className="git"><AiOutlineGithub /> &nbsp; Continue with Github</button>
                        <button className="twit"><GrTwitter /> &nbsp; Continue with Twitter</button>
                    </div>
